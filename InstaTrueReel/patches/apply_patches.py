...
def main():
    ...
    print("=" * 60 + "\nInstaTrueReel — applying patches (v13: -r decode, smali-only)\n" + "=" * 60)

    # NOTE: v12 tried full resource decode to patch styles.xml windowBackground.
    # CRASHED: aapt reassigned R.id values → requireViewById failed → crash.
    # v13: back to -r decode (preserves original IDs). windowBackground fixed
    # via runtime smali: window.setBackgroundDrawable(null) in 2ZS.A01.
