...
log ""
log "  MOUSE FIX (Windows Moonlight only):"
log "    If cursor is stuck/glitchy: Moonlight → Settings → Input →"
log "    enable 'Optimize Mouse for Remote Desktop'"
log "    (or press Ctrl+Alt+Shift+C during streaming)"
log ""
